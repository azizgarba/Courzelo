...
export class NavBarComponent {
  ...
  constructor(private chatService:ChatConsumerServiceService,private tokenStorageService: TokenStorageService,private router:Router) { }
  ...
  ngOnInit() {
    ...
    this.greetingSubject = this.chatService.getgreeting().subscribe(greeting=> {
      this.greeting = greeting;
    });
    this.greeting2Subject = this.chatService.getgreeting2().subscribe(greeting2=> {
   ...
   // console.log("malaaaaaaaaaaaaa notif/////////////////////////////////////////////////////////////",this.notificationCount2)
    ...
    this.notificationCount2Subject=this.chatService.getnotificationCount2().subscribe(notificationCount2=>{
